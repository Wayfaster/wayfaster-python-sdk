...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("WAYFASTER_USERNAME"):
        security_dict["username"] = os.getenv("WAYFASTER_USERNAME")

    if os.getenv("WAYFASTER_PASSWORD"):
        security_dict["password"] = os.getenv("WAYFASTER_PASSWORD")
